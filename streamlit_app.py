...
def explain_prediction(probability, input_dict, surname):
 ...
 Geography_Germany |   0.091373
  ...
  - If the customer has less than a 40% risk of churning, generate a 3 sentence explanation of why they are not at a risk of churning.
...
def generate_email(probability, input_dict, explanation, surname):
  prompt = f"""You area manager at HS Bank. You are responsible for ensuring customers stay with the bank and are incentivized with various offers.
